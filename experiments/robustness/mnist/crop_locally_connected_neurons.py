...
def main(seed=0, n_train=60000, inhib=250, kernel_size=(16,), stride=(2,), n_filters=25, crop=4, lr=0.01,
         ...
         update_interval=250, p_remove=0.1, new_seed=0, plot=False, gpu=False):
    ...
    test_params = [
        seed, kernel_size, stride, n_filters, crop, lr, lr_decay, n_train, inhib, time, dt,
        theta_plus, theta_decay, intensity, norm, progress_interval, update_interval, p_remove, new_seed
    ]
    ...
    if not os.path.isfile(os.path.join(results_path, name)):
        with open(os.path.join(results_path, name), 'w') as f:
            f.write(
                ...
                'theta_plus,theta_decay,intensity,norm,progress_interval,update_interval,p_remove,new_seed,mean_all_activity,'
