...
void _run_synapses_1_synapses_create_generator_codeobject()
{
	...
	///// CONSTANTS ///////////
	int32_t* const _array_synapses_1__synaptic_pre = &_dynamic_array_synapses_1__synaptic_pre[0];
const int _num_synaptic_pre = _dynamic_array_synapses_1__synaptic_pre.size();
const int _numN = 1;
int32_t* const _array_synapses_1__synaptic_post = &_dynamic_array_synapses_1__synaptic_post[0];
const int _num_synaptic_post = _dynamic_array_synapses_1__synaptic_post.size();
int32_t* const _array_synapses_1_N_incoming = &_dynamic_array_synapses_1_N_incoming[0];
const int _numN_incoming = _dynamic_array_synapses_1_N_incoming.size();
int32_t* const _array_synapses_1_N_outgoing = &_dynamic_array_synapses_1_N_outgoing[0];
